    ...
    <main>
      <div className="flex-row">"
        ...
        <section id="karatedepartment">
         ...
         <div className="container flex flex-row max-[720px]:flex-col justify-evenly px-6 mx-auto mt-10">
            <div className="flex flex-row justify-end max-[720px]:justify-center w-1/2 max-[720px]:w-full">
               <div>
                  <Image src={Shuhari} alt="shuhari gi"/>
               </div>
            </div>
            <div className="flex flex-row justify-start max-[720px]:justify-center w-1/2 max-[720px]:w-full">
